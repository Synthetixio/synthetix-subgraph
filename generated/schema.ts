...
export class RatesUpdated extends Entity {
  ...
  get currencyKeys(): Bytes[] {
    let value = this.get('currencyKeys');
    return value.toBytesArray();
  }

  set currencyKeys(value: Bytes[]) {
...
export class SelfDestructTerminated extends Entity {
  ...
  save(): void {
    let id = this.get('id');
    assert(id !== null, 'Cannot save SelfDestructTerminated entity without an ID');
    assert(
      id.kind == ValueKind.STRING,
  ...
  static load(id: string): SelfDestructTerminated | null {
    return store.get('SelfDestructTerminated', id) as SelfDestructTerminated | null;
  }
...
export class SelfDestructInitiated extends Entity {
  ...
  save(): void {
    let id = this.get('id');
    assert(id !== null, 'Cannot save SelfDestructInitiated entity without an ID');
    assert(
      id.kind == ValueKind.STRING,
  ...
  static load(id: string): SelfDestructInitiated | null {
    return store.get('SelfDestructInitiated', id) as SelfDestructInitiated | null;
  }
...
export class SelfDestructBeneficiaryUpdated extends Entity {
  ...
  save(): void {
    let id = this.get('id');
    assert(id !== null, 'Cannot save SelfDestructBeneficiaryUpdated entity without an ID');
    assert(
      id.kind == ValueKind.STRING,
  ...
  static load(id: string): SelfDestructBeneficiaryUpdated | null {
    return store.get('SelfDestructBeneficiaryUpdated', id) as SelfDestructBeneficiaryUpdated | null;
  }
