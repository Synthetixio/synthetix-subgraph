...
program.action(async () => {
  ...
  let response = await inquirer.prompt([{ name: 'continue1', type: 'confirm', message: 'Continue?' }]);
  if (response.continue1) {
  ...
  response = await inquirer.prompt([{ name: 'continue2', type: 'confirm', message: 'Continue?' }]);
...
// TODO: Add flags for all options
