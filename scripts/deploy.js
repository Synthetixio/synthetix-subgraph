...
program.action(async () => {
  ...
  if (settings.network !== 'None') {
    if (settings.network == 'All') {
      ...
      if (!settings.buildOnly) {
        await exec(
          `SNX_NETWORK=${settings.network} ./node_modules/.bin/graph deploy --node https://api.thegraph.com/deploy/ --ipfs https://api.thegraph.com/ipfs/ ${settings.team}/synthetix-main-kovan ./subgraphs/${settings.subgraph}.js`,
        );
