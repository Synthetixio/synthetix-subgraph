...
module.exports = [
  {
    ...
    startBlock: StartBlocks.Exchanger.test || StartBlocks.Exchanger.prod,
  ...
  },
  {
    name: 'Exchanger_v2',
    mappingFile: '../src/exchanger-mapping.ts',
    startBlock: StartBlocks.Exchanger_v2.test || StartBlocks.Exchanger_v2.prod,
  ...
  },
  {
    name: 'Exchanger_v3',
    mappingFile: '../src/exchanger-mapping.ts',
    startBlock: StartBlocks.Exchanger_v3.test || StartBlocks.Exchanger_v3.prod,
  ...
  },
  {
    name: 'Synthetix',
    mappingFile: '../src/exchanger-mapping.ts',
    startBlock: StartBlocks.Synthetix.test || StartBlocks.Synthetix.prod,
