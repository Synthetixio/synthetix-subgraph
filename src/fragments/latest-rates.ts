...
import { LatestRate, InversePricingInfo, RateUpdate, DailyCandle } from '../../generated/subgraphs/latest-rates/schema';
...
import { strToBytes, toDecimal, ZERO, ZERO_ADDRESS, toInt } from '../lib/helpers';
...
export function addLatestRateFromDecimal(
  ...
  updateDailyCandle(event.block.timestamp, synth, toInt(rate));
}
